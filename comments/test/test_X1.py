...
class TestX1(unittest.TestCase):
    ...
    def test_m_single_value(self):
        self.assertEqual(X1.sum_squares_of_range(3, 3), 9)

    def test_m_small_range(self):
        self.assertEqual(X1.sum_squares_of_range(1, 3), 14)

    def test_m_larger_range(self):
        self.assertEqual(X1.sum_squares_of_range(0, 3), 14)

    def test_m_negative_range(self):
        self.assertEqual(X1.sum_squares_of_range(-2, 0), 5)

    def test_m_larger_negative_to_positive(self):
        self.assertEqual(X1.sum_squares_of_range(-1, 1), 2)
